    ...
    return (
      <div className="container py-5 px-4">
        <div>
          <div className="row featurette">
            <div className="col-md-7 order-md-2">
              <h1 className="featurette-heading">{store.selectedItem.name}</h1>
        ...
        <h4>Properties:</h4>
          ...
          {Object.entries(store.selectedItem).map(([key, value], index) => (
                <div className="p-2 text-capitalized" key={index}>
